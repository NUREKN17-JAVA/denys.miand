...
public class Runtime {
  ...
  public static String getVersionInfo() {
			String CVSname = "JADE3.4"; //this keyword is automatically replaced by the target doTag of build.xml
		String CVSdate = " - revision 5874 of 2006/03/09 14:13:11"; // these keywords are automatically replaced by WCREV with subversion
    String name = CVSname; 
